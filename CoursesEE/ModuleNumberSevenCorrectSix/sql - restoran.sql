...
ALTER TABLE INGREDIENTS ADD COLUMN UNIT CHAR(5);
INSERT INTO ingredients (NAME_INGREDIENT, UNIT) VALUES ('meat (beef)', 'kg');
INSERT INTO ingredients (NAME_INGREDIENT, UNIT) VALUES ('mushroom', 'kg');
INSERT INTO ingredients (NAME_INGREDIENT, UNIT) VALUES ('egg', 'kg');
INSERT INTO ingredients (NAME_INGREDIENT, UNIT) VALUES ('cheese', 'kg');
INSERT INTO ingredients (NAME_INGREDIENT, UNIT) VALUES ('parsley', 'kg');
INSERT INTO ingredients (NAME_INGREDIENT, UNIT) VALUES ('bow', 'kg');
INSERT INTO ingredients (NAME_INGREDIENT, UNIT) VALUES ('potato', 'kg');
INSERT INTO ingredients (NAME_INGREDIENT, UNIT) VALUES ('buckwheat', 'kg');
...
ALTER TABLE WAREHOUSE DROP COLUMN UNIT;
...
INSERT INTO WAREHOUSE ( ID_INGREDIENT, QUANTITY, UNIT) VALUES (1, 2.0, 'kg');
INSERT INTO WAREHOUSE ( ID_INGREDIENT, QUANTITY, UNIT) VALUES (2, 1, 'kg');
INSERT INTO WAREHOUSE ( ID_INGREDIENT, QUANTITY, UNIT) VALUES (3, 10, 'kg');
INSERT INTO WAREHOUSE ( ID_INGREDIENT, QUANTITY, UNIT) VALUES (4, 20, 'kg');
INSERT INTO WAREHOUSE ( ID_INGREDIENT, QUANTITY, UNIT) VALUES (5, 0.5, 'kg');
INSERT INTO WAREHOUSE ( ID_INGREDIENT, QUANTITY, UNIT) VALUES (6, 0.2, 'kg');
INSERT INTO WAREHOUSE ( ID_INGREDIENT, QUANTITY, UNIT) VALUES (7, 5, 'kg');
INSERT INTO WAREHOUSE ( ID_INGREDIENT, NUMBER_INGREDIENT) VALUES (8, 2.2, 'kg');
...
ALTER TABLE DISH  
  ADD CONSTRAINT WAREHOUSE_id_ingredient_fkey FOREIGN KEY (id_ingredient)
      REFERENCES INGREDIENTS (id);
/* 
ALTER TABLE DISH ADD COLUMN IDS_INGREDIENTS_DISH TEXT;
ALTER TABLE DISH DROP COLUMN IDS_INGREDIENTS_DISH;
*/
...
(
    ...
    PREPARED_DISH CHARACTER VARYING
);


ALTER TABLE PREPARED_DISH ADD COLUMN PREPARED_DISH INT;
ALTER TABLE PREPARED_DISH DROP COLUMN PREPARED_DISH;
...
INSERT INTO PREPARED_DISH (ID_DISH, ID_USER, ID_ORDER, DATA_DISH, PREPARED_DISH)
VALUES (3, 2, 3, '2011-04-04 21:28:20', 0);
INSERT INTO PREPARED_DISH (ID_DISH, ID_USER, ID_ORDER, DATA_DISH, PREPARED_DISH)
VALUES (1, 3, 4, '2012-04-04 21:28:20', 0);
INSERT INTO PREPARED_DISH (ID_DISH, ID_USER, ID_ORDER, PREPARED_DISH)
VALUES (2, 4, 5, 0);

SELECT * FROM PREPARED_DISH;
SELECT * FROM PREPARED_DISH WHERE id=62;
...
UPDATE PREPARED_DISH SET PREPARED_DISH = 0 WHERE id=31;*/
...
ALTER TABLE ORDER_WAITER
  ADD CONSTRAINT ORDER_WAITER_IDS_DISHES_fkey FOREIGN KEY (IDS_DISHES)
      REFERENCES DISH (id);
      
   
INSERT INTO ORDER_WAITER (ID_USER, IDS_DISHES, NUMBER_TABLE, ORDER_WAITER)
VALUES (2, '1', 3, 0);
INSERT INTO ORDER_WAITER (ID_USER, IDS_DISHES, NUMBER_TABLE, ORDER_WAITER)
VALUES (3, '1', 3, 0);
INSERT INTO ORDER_WAITER (ID_USER, IDS_DISHES, NUMBER_TABLE, ORDER_WAITER)
